...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        'siteAuth' => \App\Http\Middleware\Site\Authenticate::class,
        'siteGuest' => \App\Http\Middleware\Site\RedirectIfAuthenticated::class,
        ...
        'adminAuth' => \App\Http\Middleware\Administrator\Authenticate::class,
        'adminGuest' => \App\Http\Middleware\Administrator\RedirectIfAuthenticated::class,
