...
@section('content')
    ...
    <div class="row clearfix">
        <div class="col-sm-6">
            <h2>افزودن دسته بندی محصولات</h2>
        </div>
        <div class="col-sm-6 breadcrumb-col">
            <ol class="breadcrumb">
                ...
                <li><span>افزودن دسته بندی محصولات</span></li>
            </ol>
        </div>
    </div>
    ...
    <div class="panel" id="basic">
        <div class="panel-heading b#c6f9ff">
            <i class="fa fa-pencil-square-o sort-hand"></i>دسته بندی جدید
        ...
        <div class="panel-body">
            ...
            <form action="{{ route('admin.product-category.store' )}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="title" name="title" value="{{ old('title') }}" tabindex="1" placeholder="نام" type="text" class="form-control">
                    @if ($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <textarea id=color_code name=color_code tabindex="4" placeholder="کد رنگ دسته بندی (اختیاری)" class="form-control">{{ old('color_code') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group" id="is_fav" data-toggle="buttons">
                        <label class="btn btn-default btn-on {{ old('is_fav') ? 'active' : '' }}">
                            <input type="radio" value="1" name="is_fav" {{ old('is_fav') ? 'checked' : '' }}>بله</label>
