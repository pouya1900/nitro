...
@section('content')
    ...
    <div class="panel" id="basic">
        <div class="panel-heading b#c6f9ff">
            <i class="fa fa-plus-square-o  sort-hand"></i>محصول جدید
            ...
            <form action="{{route('admin.product.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <span popover="" data-placement="top" data-trigger="hover"
                          data-content="عنوان محصول که اجباری است و در سایت نمایش داده می شود" data-original-title=""
                          title=""><i class="fa fa-question-circle"></i></span>
                    <input id="name" name="name" value="{{ old('name') }}" tabindex="1" placeholder="عنوان"
                ...
                <div class="form-group">
                    ...
                    <span popover="" data-placement="top" data-trigger="hover"
                          ...
                          title=""><i class="fa fa-question-circle"></i></span>
                    <input id="category_type" name="category_type" value="{{ old('category_type') }}" tabindex="1" placeholder="نوع"
                           type="text" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group" id="available" data-toggle="buttons">
                        <label class="btn btn-default btn-on {{ old('available') ? 'active' : '' }}">
                            <input type="radio" value="1"
                                   name="available" {{ old('available') ? 'checked' : '' }}>بله</label>
                        <label class="btn btn-default btn-off {{ !old('available')? 'active' : '' }}">
                            <input type="radio" value="0" name="available" {{ !old('available') ? 'checked' : '' }}>خیر</label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <span popover="" data-placement="top" data-trigger="hover"
                          ...
                          title=""><i class="fa fa-question-circle"></i></span>
                    <input id="rate" name="rate" value="{{ old('rate') }}" tabindex="1" placeholder="قیمت"
                           type="text" class="form-control">
                    @if ($errors->has('rate'))
                        <div class="alert alert-danger alert-dismissible" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                ...
                <div class="form-group">
                    ...
                    <span popover="" data-placement="top" data-trigger="hover"
                          ...
                          title=""><i class="fa fa-question-circle"></i></span>
                    <input id="min" name="min" value="{{ old('min') }}" tabindex="1" placeholder="حداقل"
                           type="text" class="form-control">
                    @if ($errors->has('min'))
                        <div class="alert alert-danger alert-dismissible" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                ...
                <div class="form-group">
                    ...
                    <span popover="" data-placement="top" data-trigger="hover"
                          ...
                          title=""><i class="fa fa-question-circle"></i></span>
                    <input id="max" name="max" value="{{ old('max') }}" tabindex="1" placeholder="حداکثر"
                           type="text" class="form-control">
                    @if ($errors->has('max'))
                        <div class="alert alert-danger alert-dismissible" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group" id="is_fav" data-toggle="buttons">
                        <label class="btn btn-default btn-on {{ old('is_fav') ? 'active' : '' }}">
                            <input type="radio" value="1"
                                   name="is_fav" {{ old('is_fav') ? 'checked' : '' }}>بله</label>
                        <label class="btn btn-default btn-off {{ !old('is_fav')? 'active' : '' }}">
                            <input type="radio" value="0" name="is_fav" {{ !old('is_fav') ? 'checked' : '' }}>خیر</label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input id="description" name="description" value="{{ old('description') }}" tabindex="1" placeholder="توضیحات"
                           type="text" class="form-control">
...
@section('custom_script')
    ...
    <script>
        ...
        $(function () {
            // Now that the DOM is fully loaded, create the dropzone, and setup the
            // event listeners
            var myDropzone2 = new Dropzone("div#content_video", {
